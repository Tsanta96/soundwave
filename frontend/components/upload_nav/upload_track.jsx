...
class UploadTrackForm extends React.Component {
  ...
  renderErrors() {
    if (this.props.errors) {
      return Object.values(this.props.errors).map((error, idx) => (
        <li key={idx}>*{error}</li>
      ));
    }
  }
    ...
    return (
      <div>
        <div className="upload-nav">
          <NavLink to="/nav/upload" className="upload" activeClassName="chosen">
            Upload
          </NavLink>
          <NavLink
            to="/nav/you/tracks"
        ...
        <div className="upload-track-view">
          ...
          <form className="upload-track-form">
            ...
            <div className="upload-form-errors">{this.renderErrors()}</div>
            <button
              className="upload-track-form-submit"
